	 ...
	 @Test(priority = 17)
	  public void check_and_update_superviaor_without_using_attherate ()
	  {
	    ...
	    try {
	    	 WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(100));
	    	 wait2.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".loader")));
  	        wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("(//td[@class='actionIcon']/span)[2]")));
...
//		            softAssert.assertEquals(actual, expected);
	        ...
	        @Test(priority = 29)
		    public void Verify_that_to_select_orgnization_from_filter_and_see_supervisor() throws IOException {
...
//		            softAssert.assertEquals(actual, expected);
	        ...
	        @Test(priority = 30)
		    public void Verify_that_search_and_select_orgnization_from_filter_and_see_supervisor() throws IOException {
		        ...
		        try {
		           ...
		           driver.findElement(By.xpath("//span[@class='dropDownIcon']")).click();
		             Thread.sleep(3000);
		             driver.findElement(By.xpath("//input[@placeholder='Select Organization']")).sendKeys("Tipco Engineer");
		             Thread.sleep(3000);
		           driver.findElement(By.xpath("//div[text()='Tipco Engineering']")).click();
//		            String actual = driver.findElement(By.xpath("//a[text()='Previous']")).getText();
//		            String expected = "Previous";
...
//		            softAssert.assertEquals(actual, expected);
	        ...
	        @Test(priority = 31)
		    public void Verify_that_search_the_orgnization_that_are_not_present_in_list_box_and_see_valid_error_message() throws IOException {
		        ...
		        try {
		           ...
		           driver.findElement(By.xpath("//span[@class='dropDownIcon']")).click();
		             Thread.sleep(3000);
		             driver.findElement(By.xpath("//input[@placeholder='Select Organization']")).sendKeys("Xylo moren");
		           
		           
		            String actual = driver.findElement(By.xpath("//div[text()='Invalid Organization!']")).getText();
		            String expected = "Invalid Organization!";
		            System.out.println("dhkjfh" + actual);
	        ...
	        @Test(priority = 51)
		    public void Verify_that_click_on_tipco_Logo_from_supervisor_page_and_redirect_on_dashborad() throws IOException {
